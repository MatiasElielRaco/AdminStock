<main class="main">
    <div class="main__contenedor">
        ...
        <picture>
            <source srcset="build/img/Dashboard.avif" type="image/avif">
            <source srcset="build/img/Dashboard.webp" type="image/webp">
            <img loading="lazy" width="100" height="100" src="build/img/Dashboard.png" alt="Dashboard AdminStock">
        </picture>
    </div>
</main>
